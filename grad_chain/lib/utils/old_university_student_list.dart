...
class UniversityStudentList extends StatefulWidget {
  ...
  UniversityStudentList({super.key});

  //UniversityStudentList({addedStudents});

  @override
  State<UniversityStudentList> createState() => _UniversityStudentListState();
}

class _UniversityStudentListState extends State<UniversityStudentList> {
  List<String> _addedStudents = [];
  String UID = 'FRMYr9ryoZZVkl8ADJTmfbX2hh13';
...
*/
                        ...
                        itemBuilder: (BuildContext, int index) {
                          return ListTile(
                            ...
                            title:
                                ClaimCard(snap: snapshot.data!.docs[0].data()),
